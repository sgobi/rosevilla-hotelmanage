...
<head>
    ...
    <title>{{ ($isProforma ?? false) ? 'Garden Quotation / Proforma Invoice' : 'Garden Booking Confirmation' }} #{{ $booking->id }} - Rose Villa</title>
    <style>
        body { 
...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="meta-data">
            ...
            <div class="meta-row"><span class="label">From</span><span class="separator">:</span><span>Garden Department</span></div>
            <div class="meta-row"><span class="label">Subject</span><span class="separator">:</span><span>{{ ($isProforma ?? false) ? 'Garden Quotation / Proforma Invoice' : 'Garden Booking Confirmation' }}</span></div>
        </div>
        ...
        <div class="details-list">
            <div class="details-row">
                ...
                <span>: <strong>G-{{ str_pad($booking->id, 5, '0', STR_PAD_LEFT) }}</strong></span>
            </div>
            <div class="details-row">
            ...
            <div class="details-row">
                ...
                <span>: {{ $booking->check_in->format('d-m-Y') }} to {{ $booking->check_out->format('d-m-Y') }}</span>
            </div>
            <div class="details-row">
        ...
        <div class="footer">
            <p>Please note that garden bookings are subject to our standard event policies. Cancellations must be made at least 14 days in advance.</p>
            <p>If you require any information prior to your event, please visit our website www.rosevillaheritagehomes.com or contact our team.</p>
            <p><strong>We are looking forward to hosting your event at Rose Villa Heritage Homes.</strong></p>
        </div>

        {{-- Footer Signature --}}
        <div class="signature">
            <p class="signature-title">Garden Bookings Manager</p>
