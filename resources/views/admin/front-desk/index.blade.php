    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('admin.front-desk.calendar') }}" class="group relative px-6 py-2.5 bg-indigo-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-lg shadow-indigo-200 hover:bg-black hover:shadow-xl transition-all active:scale-95 flex items-center gap-2">
        ...
        <div class="max-w-[1600px] mx-auto px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-10">
                ...
                <div class="space-y-10">
                    {{-- ARRIVALS CARD --}}
                    <div class="bg-indigo-50/50 rounded-[3rem] p-8 border border-white/50">
                    ...
                    {{-- DEPARTURES CARD --}}
                    <div class="bg-amber-50/50 rounded-[3rem] p-8 border border-white/50">
                        <div class="flex items-center justify-between mb-8 px-2">
                            <div class="flex items-center gap-4">
                                                    ...
                                                    <div x-show="open" x-cloak
                                                        ...
                                                        <div @click.away="open = false" 
                                                            ...
                                                            <div class="p-8 space-y-8">
                                                                {{-- Operational Reset --}}
                                                                <form action="{{ route('admin.front-desk.reset', $res) }}" method="POST" class="space-y-4">
                                                                    @csrf
                                                                    ...
                                                                    <button type="submit" 
                                                                            onclick="return confirm('Clear all operations for this guest? The reservation stays approved.')"
                                                                            class="w-full bg-rose-50 text-rose-600 py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-100 transition-all active:scale-95">
                                                                ...
                                                                <div class="relative flex items-center justify-center">
                                                                    ...
                                                                    <span class="relative bg-white px-4 text-[9px] font-black text-gray-300 uppercase tracking-widest">OR DESTROY RECORD</span>
                                                                </div>
                                                                ...
                                                                <form action="{{ route('admin.reservations.destroy', $res) }}" method="POST" class="space-y-4">
                                                                    ...
                                                                    <button type="submit" 
                                                                            ...
                                                                            class="w-full bg-red-600 text-white py-5 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-black transition-all shadow-xl shadow-red-100 active:scale-95">
                                                                        Delete Record Permanently
                                                                    </button>
                                                                </form>
                                                            </div>
                                                            <div class="bg-gray-50/50 p-6 text-center">
                                                                <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest italic group">Verified Administrative Operation</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </template>
