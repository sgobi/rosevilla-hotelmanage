                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($recentSales as $sale)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-3 text-gray-500 text-xs">{{ $sale->created_at->format('M d, H:i') }}</td>
                                    <td class="px-6 py-3">
                                        <span class="px-2 py-0.5 rounded-md text-[9px] font-bold uppercase
                                            {{ $sale->type === 'Room' ? 'bg-blue-50 text-blue-700' : 'bg-purple-50 text-purple-700' }}">
                                            {{ $sale->type }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-3">
                                        <div class="font-medium text-gray-900">{{ $sale->display_name }}</div>
                                        <div class="text-[10px] text-gray-400">#{{ $sale->id }}</div>
                                    </td>
                                    <td class="px-6 py-3 text-gray-600 text-xs">{{ $sale->room->title ?? '-' }}</td>
                                    ...
                                    <td class="px-6 py-3 text-center">
                                        ...
                                        @endphp
                                        <a href="{{ $invoiceRoute }}" target="_blank" class="text-gray-400 hover:text-indigo-600 transition-colors p-1 rounded-md hover:bg-indigo-50 inline-block">
