<nav x-data="{ open: false }" class="bg-[#0a0a0a]/95 backdrop-blur-3xl border-b border-white/5 sticky top-0 z-50 shadow-[0_10px_40px_rgba(0,0,0,0.5)]" style="transform: translateZ(0); -webkit-font-smoothing: antialiased;">
                ...
                <div class="hidden space-x-1 md:flex items-center">
                    ...
                    <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                        ...
                        <div x-show="open" 
                            ...
                            <x-dropdown-link :href="route('admin.garden-profile.edit')" class="text-[11px] font-black uppercase tracking-wider py-4 hover:bg-white/10 hover:text-white transition-all duration-500 px-8 text-gray-300">Garden Profile</x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden bg-[#161616] border-t border-white/5 pb-16 animate-fade-in-down">
        <div class="pt-8 space-y-1">
            ...
            <div class="px-8 py-2 text-[9px] font-black text-amber-500 uppercase tracking-[0.2em] italic">Open Quotations</div>
            <x-responsive-nav-link :href="route('admin.reservations.index', ['status' => 'pending'])" :active="request()->get('status') === 'pending' && request()->routeIs('admin.reservations.*')" class="text-amber-400 font-bold text-[11px] uppercase tracking-wider px-14 hover:text-white transition-colors py-4">Room Quotes</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.events.index', ['status' => 'pending'])" :active="request()->get('status') === 'pending' && request()->routeIs('admin.events.*')" class="text-amber-400 font-bold text-[11px] uppercase tracking-wider px-14 hover:text-white transition-colors py-4">Event Quotes</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.garden-bookings.index', ['status' => 'pending'])" :active="request()->get('status') === 'pending' && request()->routeIs('admin.garden-bookings.*')" class="text-amber-400 font-bold text-[11px] uppercase tracking-wider px-14 hover:text-white transition-colors py-4">Garden Quotes</x-responsive-nav-link>
            ...
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.garden-profile.edit')" :active="request()->routeIs('admin.garden-profile.*')" class="text-gray-400 font-bold text-[11px] uppercase tracking-wider px-14 py-4">Garden Profile</x-responsive-nav-link>
