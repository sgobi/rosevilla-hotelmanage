...
class ContentController extends Controller
{
    ...
    public function update(Request $request)
    {
        $fields = $request->validate([
            ...
            'reach_time_jaffna' => ['nullable', 'string', 'max:255'],
            'reach_time_airport' => ['nullable', 'string', 'max:255'],
            'reach_time_railway' => ['nullable', 'string', 'max:255'],
            'reach_time_bus' => ['nullable', 'string', 'max:255'],
